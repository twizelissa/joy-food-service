 ...
 * 8. Map Responsive Handling
 * ----------------------------
 * Adjust map height based on screen size for better mobile experience
 */
function makeMapResponsive() {
  ...
  // Adjust map height based on screen width
  const windowWidth = window.innerWidth;
  ...
  // Enhance map button interaction
  const mapButton = document.querySelector(".map-label a");
  if (mapButton) {
    mapButton.addEventListener("mouseenter", function () {
      this.style.backgroundColor = "#91654d";
      this.style.color = "white";
    });

    mapButton.addEventListener("mouseleave", function () {
      this.style.backgroundColor = "";
      this.style.color = "#91654d";
    });

    // Make button adapt to screen size
    if (windowWidth <= 480) {
      mapButton.style.width = "90%";
      mapButton.style.maxWidth = "280px";
    } else if (windowWidth <= 768) {
      mapButton.style.width = "80%";
      mapButton.style.maxWidth = "250px";
    } else {
  ...
  // Ensure map scales correctly after resize
  setTimeout(() => {
    // Force map to redraw by triggering a resize event
